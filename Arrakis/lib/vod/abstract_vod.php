...
abstract class AbstractVod implements Vod
{
    ...
    public function get_genre_icon_url($genre_id, &$plugin_cookies)
    { throw new Exception('Not implemented'); }
    ...
    public function get_vod_genres_folder_views(&$plugin_cookies)
    { throw new Exception('Not implemented'); }

    public function get_vod_series_folder_views(&$plugin_cookies)
    {
        return array(
            array
            (
