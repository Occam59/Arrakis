    ...
    implements UserInputHandler
{
    ...
    {
        return $this->tv->get_tv_channel_list_folder_views($plugin_cookies);
    }
    ...
    public function get_action_map(MediaURL $media_url, &$plugin_cookies)
    {
        ...
        $move_backward_favorite_action['caption'] =
            T::t('tv_action_backward');

        $move_forward_favorite_action =
            UserInputHandlerRegistry::create_action(
                $this, 'move_forward_favorite');
        $move_forward_favorite_action['caption'] =
            T::t('tv_action_forward');

        $remove_favorite_action =
            UserInputHandlerRegistry::create_action(
                $this, 'remove_favorite');
        $remove_favorite_action['caption'] =
            T::t('tv_action_favorite');

        $menu_items[] = array(
            GuiMenuItemDef::caption =>
            T::t('tv_action_remove_from_favorites'),
